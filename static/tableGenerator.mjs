...
export const tableGenerator = (value, data, collisionCount, longestCollision) => {
    ...
    //create mini-table
    const table = createTable(uniqueLvl, cmpLvl, viability, collisionCount, longestCollision)
